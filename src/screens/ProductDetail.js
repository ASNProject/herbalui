  ...
  return (
    <View style={[GS.container, GS.mt4]}>
      ...
      <View style={[GS.mt3, Style.descriptionColumn, GS.pt2]}>
        <Text style={[GS.fs5, GS.fwLight]}>{route.params.description}</Text>
      </View>
    </View>
  );
};
      ...
      <View>
        ...
        <View style={[GS.mt4]}>
          ...
          <Text style={[GS.mt3, GS.fwLight]}>
            ini bisa untuk sakit hati engga ya? trims
          </Text>
          {/* answer */}
          <View
            style={[
  ...
  return (
    <SafeAreaView style={[{ backgroundColor: '#fff', height: '100%' }]}>
      ...
      <ScrollView style={[{ backgroundColor: '#fff', height: '100%' }]}>
        ...
        <View style={[GS.container, GS.mt4]}>
          <View>
            <Text style={[GS.fwMedium, GS.fs3]}>{route.params.name}</Text>
            <Text style={[GS.fs3]}>{route.params.price}</Text>
          </View>
          <View style={[GS.mt4]}>
            <Text style={[GS.fs5]}>Deskripsi</Text>
            <View style={[GS.flexRow]}>
